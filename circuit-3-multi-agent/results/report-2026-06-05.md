...
Workers dispatched: 3 | completed: 3 | duration: 3616ms
Simulated spend: 81000 raw USDC | session cap: 100000 | within budget: true

## worker-A-product (product) — ok in 462ms, would-cost 30000 raw USDC
```json
{
  "company": "Coinbase",
  "products": [
...
## worker-B-news (news) — ok in 417ms, would-cost 50000 raw USDC
```json
{
  "company": "Coinbase",
  "headlines": [
...
## worker-C-price (price) — ok in 584ms, would-cost 1000 raw USDC
```json
{
  "company": "Coinbase",
  "feeds": {
